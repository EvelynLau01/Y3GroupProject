...
void precompSwrcGP_Hamming (swrcGP_HammingStruct *swrcGP_Hamming) {
  swrcGP_Hamming->M=swrcGP_Hamming->N-swrcGP_Hamming->K;    // Calculate Parity bit: M = N - K
  ...
  swrcGP_Hamming->GP_HammingChannel.R = (double) swrcGP_Hamming->K/swrcGP_Hamming->N;
...
void initBerResultStructSwrcGP_Hamming (swrcGP_HammingStruct *swrcGP_Hamming,berResultStruct *berResult,char *berResultFilename) {
  ...
  // For SNR value
  pushBerResultField(berResult,"SNRdB","double","%10.8lf",&swrcGP_Hamming->GP_HammingChannel.SNR);
...
void runSwrcGP_Hamming (swrcGP_HammingStruct *swrcGP_Hamming) {
  ...
  precompSwrcGP_Hamming(swrcGP_Hamming);
  initBerResultStructSwrcGP_Hamming(swrcGP_Hamming,&berResult,"../../Documents/MatlabDrive/swrcGP_Hamming.berResult"); // Trying to modify the file path of berResult file
  if (checkParametersSwrcGP_Hamming(swrcGP_Hamming)>0) {
    printf("Exiting swrcGP_Hamming\n");
    exit(-1);
  }
